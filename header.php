  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMain">
      <div class="navbar-nav">
        ...
        <a href="#" class="nav-link" onclick="document.location='cart.php'"><b>My cart</b></a>
      </div>
      <div class="search">
    <form class="searchbox" action="search.php">
      ...
      <div class="navbar-nav ms-auto iconuser">
        ...
        ?>
        <p href="#" style="color: black; font-weight:bold; "; class="nav-item nav-link ">Welcome  <?=$_SESSION['user_email']?>  </p>
